  ...
  render() {
    ...
    return (
      <div className="App">
        ...
        {this.state.prizeBox ? <React.Fragment><div class="PrizeBoxContainerL"><img className="Prize" src={bouncyball} alt="bouncyball" /><p className="boxprice">{this.state.bouncyball}</p></div><div class="PrizeBoxContainerR"><img className="Prize" src={dino} alt="dino" /><p className="boxprice">{this.state.dino}</p></div><div class="PrizeBoxContainer"><img className="Prize" src={lizards} alt="lizards" /><p className="boxprice">{this.state.lizards}</p></div><div class="PrizeBoxContainer"><img className="Prize" src={peppa} alt="peppa" /><p className="boxprice">{this.state.peppa}</p></div><div class="PrizeBoxContainer"><img className="Prize" src={chalk} alt="chalk" /><p className="boxprice">{this.state.chalk}</p></div><div class="PrizeBoxContainer"><img className="Prize" src={fish} alt="fish" /><p className="boxprice">{this.state.fish}</p></div></React.Fragment> : null }
